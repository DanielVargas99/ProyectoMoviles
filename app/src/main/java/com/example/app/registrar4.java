...
public class registrar4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fuerza = getIntent().getStringExtra("fuerza");
        regate = getIntent().getStringExtra("regate");
        tiro = getIntent().getStringExtra("tiro");
        pase = getIntent().getStringExtra("pase");
    ...
    public void registroJugador(DatabaseReference tablaRef, FirebaseUser usuario, String correo, String contraseña){
        ...
        jugadores.put("velocidad", velocidad);
        jugadores.put("fuerza", fuerza);
        jugadores.put("regate", regate);
        jugadores.put("tiro", tiro);
        jugadores.put("pase", pase);
